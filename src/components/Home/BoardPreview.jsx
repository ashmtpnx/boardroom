...
// A purely decorative, non-interactive mock of a live board — sticky notes, a
    ...
    <div className={styles.preview} aria-hidden="true">
      ...
      <svg className={styles.previewSvg} viewBox="0 0 420 300" preserveAspectRatio="none">
        <path
          ...
          fill="none" stroke="#1a73e8" strokeWidth="4" strokeLinecap="round"
        />
        <path
          d="M250 120 L300 175"
          fill="none" stroke="#5f6368" strokeWidth="2" strokeDasharray="5 6" strokeLinecap="round"
        />
      </svg>
      ...
      <div className={`${styles.cursor} ${styles.cursorB}`}>
        <svg width="16" height="16" viewBox="0 0 16 16"><path d="M1 1l5 14 2-6 6-2z" fill="#a142f4" /></svg>
        <span style={{ background: '#a142f4' }}>Leo</span>
      </div>
    </div>
  );
}
