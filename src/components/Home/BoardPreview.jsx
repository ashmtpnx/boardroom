...
// watch simulated real-time collaborators (Gulu & Anvi) interact live.
export default function BoardPreview() {
  ...
  const [notes, setNotes] = useState([
    ...
    { id: 3, text: 'Zero latency engine', left: 66, top: 68, color: '#d8ffd6', rot: -2, author: 'Anvi' },
  ]);
  ...
  const [remoteCursors, setRemoteCursors] = useState([
    ...
    { id: 'anvi', name: 'Anvi', x: 72, y: 55, color: '#8b5cf6', action: 'Typing note' },
  ]);
  const containerRef = useRef(null);

  // Simulated live remote activity (Gulu & Anvi gliding and interacting)
  useEffect(() => {
